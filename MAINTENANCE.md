...
8. 本项目面向中国大陆 Android 用户，UI 参考应优先贴近国内生活工具/效率工具的清爽、轻量、入口明确和信息密度适中的审美。
9. 海外 App、Material Design 或欧美 SaaS 只能作为局部参考，不得直接照搬大留白 hero、强品牌渐变、夸张插画、霓虹玻璃、重阴影等视觉套路。
10. 后续做主题色、按钮、卡片、动效或我的页改版时，必须同步检查是否偏离 `VISUAL_SYSTEM_GUIDE.md` 中的“中国大陆市场 UI 审美适配”章节。
